...
## Personal rules
<!-- SLOT 1: your rule here. Example: every list has a designed empty state
     with one clear action. -->
<!-- SLOT 2: your rule here. Example: French and English copy both reviewed,
     no machine-translation artifacts. -->
<!-- SLOT 3: your rule here. Example: dark mode is first-class, not a filter. -->
